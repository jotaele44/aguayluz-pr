...
|---|---|---|
| **`ROAD_TO_100.md`** (~90%) | code completeness against intended scope | the code exists, works, and is exercised — every module exists and is tested; gap is live-feed tier |
| **`MATURITY_AUDIT.md`** (70%) | professional maturity of the repo as an engineering artifact | a **gate** keeps it working: CI-enforced lint, types, coverage, and frontend tests |
