...
4. Decompose future mycelial Phase 1 work by adopted independent ballots.
5. Run bounded network-enabled USGS and NEON receipts before promoting `implemented_unverified_live` categories.
6. Obtain an authorized outage source before T1 outage lifecycle claims.
