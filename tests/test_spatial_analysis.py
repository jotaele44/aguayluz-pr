from aguayluz.spatial_analysis import DirectedEdge, RasterSpec, impacted_assets, raster_layer_contract, trace_downstream, trace_upstream

EDGES=[DirectedEdge("A","B"),DirectedEdge("B","C"),DirectedEdge("B","D"),DirectedEdge("D","E")]
...
def test_raster_contract_validation():
    spec=RasterSpec("dem","s3://bucket/dem.tif","EPSG:32161",(-67.3,17.8,-65.2,18.6),10,10,source_authority="USGS")
