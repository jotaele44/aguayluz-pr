    ...
    docs.append(
        {
            ...
            "fallback_url": "https://example.test/quebradillas-hmp.pdf",
    ...
    docs.append(
        {
            ...
            "fallback_document_class": "hazard_mitigation_plan",
            "fallback_url": "https://example.test/florida-hmp.pdf",
            "fallback_relationship": "authoritative_fallback_not_equivalent",
        }
    )
    return {
...
def test_consumer_preserves_source_states_and_fallbacks():
    ...
    assert (
        out["by_municipality"]["Quebradillas"]["operational_document_class"]
