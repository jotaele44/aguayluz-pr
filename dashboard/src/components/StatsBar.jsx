...
import { useAssetsGeojson, useEvents, useHealth, useReviewQueue } from '@/lib/hooks'
import { Activity, AlertTriangle, Database, Droplets, MapPinned, ShieldCheck, WifiOff } from 'lucide-react'
...
export default function StatsBar() {
  ...
  return (
    <div className="flex items-center gap-2 border-b border-slate-800 bg-slate-900/60 px-4 py-2 overflow-x-auto">
